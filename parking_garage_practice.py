class ParkingGarage:
  ...
  def user_choice(self):
        while True:
            choice = int(input('****Welcome to the parking garage*****\n'
            ...
            if choice == 1:
                ...
                print('Invalid choice. Please enter [1] to take a ticket, [2] to pay your ticket, [3] to leave the garage, or [4] to quit.')
